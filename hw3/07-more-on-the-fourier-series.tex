...
\pe{a fourier series can be shifted by any value t in an interval.
For what interval is the fourier series of cos(n+1) even? What is the
cosine fourier series of cos on an even interval?}
